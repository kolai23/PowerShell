...
Your Zoiper password: <b>' . $sippwd . '</b> <br><br>

				<form action="sip-pass-en.php" method="post">
					Change password to <input type="text" class="" style="width:150px;" placeholder="Input new password..." value="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="pass">
					<input type="submit" class="" style="" value="Apply">
				</form>
