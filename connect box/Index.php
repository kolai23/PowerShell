...
<form name="myForm" class="decor" method="post">
	<div class="form-inner">
		...
		<div align="left">Выберите пользователя
			<?php
		...
		<div>
			<input type="button" id="showDialog" value ='Подключить ящик' onclick="fun3()">
			<input type="button" name="clear" id="clear" value ='Отключить ящик' onclick="fun4()">
		</div>
		<b><p id="status" align="center"; style="color:green;"></b>
...
<script>
	...
	function fun2() { 
		...
		document.getElementById("demo1").innerHTML = selection.textContent;
	}
