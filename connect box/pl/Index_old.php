...
<body>
 ...
 <form  action="index.php" method="post" >
	...
	echo '</select>';
		...
		$file = file("c:/inetpub/Mail/Managers/users.txt");
		echo '<select name="recipient">';
		foreach($file as $key=>$value){
		echo '<option>'.$value.'</option>';
		}
    ...
    <td></td>
    <td><input type="submit" name="set" id="set" value="Ustawić przekierowanie" style="height: 22px; width: 180px"></td>
    </tr>
	<td></td>
     <td><input type="submit" name="clear" id="clear" value="Usunąć przekierowanie" style="height: 22px; width: 180px"></td>
    </tr>
   </table>
  </form>
...
{	
	...
	$f = fopen("C:\\inetpub\\Mail\\Requests\\".$file_name, "w+");
	fwrite($f,$string."\r\n".$_POST['sender']."\r\n".$_POST["recipient"]."\r\n"."set"."\r\n"); 
	fclose($f);
	echo '<b><p align="center"; style="color:green;">Wniosek przyjęty!</style></b>';
